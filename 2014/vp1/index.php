...
<title>VP1 Atdorf, @mi 17.5,   &Delta; 17.5</title>
</head>

<body>
<h1>VP1 Atdorf, @mi 17.5,   &Delta; 17.5</h1>

<?php include("../vp_result_describe.php"); ?>

<div>
<form name="vp1_form" id="vp1_form" method="POST" action="../vp-results.php"  accept-charset="utf-8">
<input type="button" name="1" id="loader" value="Laden" /> <input type="submit" id="saver" value="Senden" />
<br>
