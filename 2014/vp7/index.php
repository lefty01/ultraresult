...
<title>VP7 Teufelsbruch @mi 96.8, &Delta; 13.36</title>
</head>

<body>
<h1>VP7 Teufelsbruch @mi 96.8, &Delta; 13.36</h1>

<?php include("../vp_result_describe.php"); ?>

<div>
<form name="vp1_form" id="vp1_form" method="POST" action="../vp-results.php"  accept-charset="utf-8">
<input type="button" name="7" id="loader" value="Laden" /> <input type="submit" id="saver" value="Senden" />
<br>

  <input type="hidden" name="VP" value="7">
  <input type="hidden" name="access" value="save">

<table id="vp7_times" class="sortable" border="1">
  <tr>
    <th class="num">Num</th>
    <th>Name</th>
    <th>In (hh:mm) </th>
